...
use Aura\Base\Tests\Fixtures\ComponentSlots\ComponentSlotPluginServiceProvider;
use Aura\Base\Tests\TestCase;
use LogicException;

abstract class ComponentSlotProviderOrderTestCase extends TestCase
{
    protected function getPackageProviders($app): array
    {
        ...
        array_splice($providers, $pluginIndex, 0, [ComponentSlotPluginServiceProvider::class]);

...
$description = "Aura CMS Plugin: {$packageSlug}";
...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('resources/views/components/fields/skeleton.blade.php')) => rename($file, determineSeparator('./resources/views/components/fields/'.$packageSlug.'.blade.php')),
        str_contains($file, determineSeparator('resources/views/components/fields/skeleton-view.blade.php')) => rename($file, determineSeparator('./resources/views/components/fields/'.$packageSlug.'-view.blade.php')),

<x-aura::layout.guest>
    ...
    <form method="POST" action="{{ url()->full() }}">
        ...
        <div>
            ...
            <x-aura::text-input id="team" class="block mt-1 w-full bg-gray-200 opacity-50 text-black" type="text" name="team" :value="$team->name" disabled />
        ...
        <div class="mt-4">
            ...
            <x-aura::text-input id="email" class="block mt-1 w-full bg-gray-200 text-black opacity-50" type="email" name="email" :value="$teamInvitation->email" disabled />

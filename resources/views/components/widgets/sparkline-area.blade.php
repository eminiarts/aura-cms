<div class="overflow-hidden h-full aura-card" wire:key="sparkline-area-{{ $widget['slug'] ?? '' }}" @if (!$isCached) wire:init="loadWidget" @endif>
    @if($loaded)
            ...
            <svg viewBox="0 0 300 80" preserveAspectRatio="none" class="w-full h-16 text-gray-100 dark:text-gray-700">
                <defs>
                    <linearGradient id="grad" x1="0%" y1="0%" x2="0%" y2="100%">
                        ...
                        <stop offset="30%"  style="stop-color:currentColor;stop-opacity:0.5" />

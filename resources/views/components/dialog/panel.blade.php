        ...
        <div class="relative min-h-full flex justify-center items-end sm:items-center p-0 sm:p-4">
            ...
            >
                ...
                <div class="absolute top-0 right-0 pt-4 pr-4">
                    <div x-on:click="$dialog.close()" class="cursor-pointer bg-gray-50 rounded-lg p-2 text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">

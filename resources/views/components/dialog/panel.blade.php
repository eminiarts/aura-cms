<template x-teleport="body">
    <div x-on:click.stop="console.log('stop here')">
        <div x-dialog x-model="dialogOpen" style="display: none"
            ...
            <!-- Overlay -->
            <div x-dialog:overlay x-transition:enter.opacity class="fixed inset-0 bg-black/25"
                x-on:click="$dialog.close()"></div>

            <!-- Panel -->
            <div x-on:click="$dialog.close()" class="relative min-h-full flex justify-center items-end sm:items-center p-0 sm:p-4">

<div class="flex flex-col mt-2" wire:key="table-index">
    <div class="overflow-hidden bg-white rounded-xl ring-1 shadow-xs dark:bg-gray-800 ring-gray-950/10 dark:ring-white/10">
                    ...
                    <tr>
                        <td colspan="{{ count($this->headers) + 2 }}">
                            <div class="flex flex-col items-center px-6 py-20 text-center">
                                <div class="flex justify-center items-center w-12 h-12 bg-gray-50 rounded-full ring-1 ring-gray-950/10 dark:bg-white/5 dark:ring-white/10">

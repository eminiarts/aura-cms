...
@if($this->editInModal)
<a href="#" wire:click.prevent="$dispatch('openModal', { component: 'aura::post-edit-modal', arguments: { 'resource': {{ $row->id }}, 'type': '{{ $row->getType() }}' }, modalAttributes: {'slide_over': true }})">

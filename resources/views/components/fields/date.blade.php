...
>
    <span class="inline-flex items-center px-aura::3 text-gray-500 border border-r-0 border-gray-500/30 dark:border-gray-700 rounded-l-md bg-gray-50 dark:bg-gray-700 sm:text-sm">

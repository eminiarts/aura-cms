<x-aura::fields.wrapper :field="$field">
  <div class="relative">
    ...
    <div class="absolute inset-y-0 right-0 flex items-center px-aura::2 pointer-events-none">

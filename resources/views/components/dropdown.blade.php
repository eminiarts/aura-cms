@props(['align' => 'right', 'width' => 'w-48', 'contentClasses' => 'p-1 bg-white dark:bg-gray-800 dark:text-gray-200', 'closeOnSelect' => true])
...
<div class="relative" x-data="{
    ...
    <div x-show="open"
            ...
            class="absolute z-10 mt-2 {{ $width }} rounded-lg shadow-lg {{ $alignmentClasses }}"
            style="display: none;"
            @if($closeOnSelect)
            @click="open = false"
            @endif

        ...
        <div class="flex justify-between items-center mb-4 aura-card-small">
          ...
          <div class="flex space-x-2">
              <x-aura::tippy text="Duplicate">
                <x-aura::button.border size="xs" wire:click="duplicateField({{ $field['_id'] }}, '{{ $field['slug'] }}', '{{ $this->slug }}')">
              ...
              <x-aura::tippy text="Edit {{ $field['name'] }}" position="top-end">
                <div wire:click="$dispatch('openSlideOver', { component: 'edit-field', parameters: { fieldSlug: '{{ $field['slug'] }}', slug: '{{ $slug }}', field: @js($this->sendField($field['slug'])), model: '{{ $this->slug }}' }})">

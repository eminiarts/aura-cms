    ...
    @else
        ...
        <div class="flex justify-between items-center mb-4 aura-card-small">
          ...
          <div class="flex space-x-2">
              ...
              <x-aura::tippy text="Edit field">
                <x-aura::button.border size="xs" wire:click="$dispatch('openSlideOver', { component: 'edit-field', parameters: { fieldSlug: '{{ $field['slug'] }}', slug: '{{ $slug }}', field: '{{ json_encode($this->sendField($field['slug'])) }}' } })">

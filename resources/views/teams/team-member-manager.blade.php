                ...
                <x-slot name="form">
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            ...
                            <div class="relative z-0 mt-1 border border-gray-400/30 rounded-lg cursor-pointer">
                                @foreach ($this->roles as $index => $role)
                                    <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-primary-300 focus:ring focus:ring-primary-200 {{ $index > 0 ? 'border-t border-gray-400/30 rounded-t-none' : '' }} {{ ! $loop->last ? 'rounded-b-none' : '' }}"

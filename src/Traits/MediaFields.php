...
trait MediaFields
{
    ...
    public function canRenderMediaSelection(mixed $selected): bool
    {
        ...
        try {
            $this->authorizedMediaForField($selected);
    ...
    public function updateField(mixed $data): void
    {
        ...
        $this->dispatchMediaSelectionEffects($data['slug'], $data['value']);
    }
    ...
    protected function dispatchMediaSelectionEffects(string $slug, mixed $value): void
    {
        $data = [
            'slug' => $slug,
            'value' => $value,

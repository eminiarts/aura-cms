...
class TriggerFlowOnDeletedPostEvent implements ShouldQueue
{
    use Dispatchable;
    use InteractsWithQueue;
    use Queueable;
    // We can not use SerializesModels here, because we need to pass the Post object to the Job, and the Post object is not serializable (because it is deleted)

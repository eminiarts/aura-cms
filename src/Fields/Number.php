...
use Aura\Base\Fields\Filters\NumberFieldFilter;
 ...
 */
class Number extends Field implements ProvidesFilterCapability
{
    ...
    public function provideAuraFilterCapability(Resource $model, array $field): FilterCapability
    {
        return FilterCapability::custom(
            'aura::fields.filters.text',
            $this->filterOptions(),
            NumberFieldFilter::class,
        );
    }
